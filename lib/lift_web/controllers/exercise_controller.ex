defmodule LiftWeb.ExerciseController do
  ...
  def create(conn, %{"exercise" => exercise_params}) do
    case Workouts.create_exercise(exercise_params) do
      {:ok, exercise} ->
        conn
  ...
  def update(conn, %{"id" => id, "exercise" => exercise_params}) do
    ...
    case Workouts.update_exercise(exercise, exercise_params) do
      {:ok, exercise} ->
        conn
  ...
  def delete(conn, %{"id" => id}) do
    exercise = Workouts.get_exercise!(id)
    {:ok, _exercise} = Workouts.delete_exercise(exercise)
